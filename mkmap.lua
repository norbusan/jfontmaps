...
local foundry = {
   ...
   ['ipaex']   = {
      noncid = true, 
      ml='ipaexm', mr='ipaexm', mb='ipaexm',
      gr='ipaexg', gru='ipaexg', gb='ipaexg', ge='ipaexg',
      mgr='ipaexg',
      {''},
   },
   ['kozuka']   = {
   ...
   ['morisawa'] = {
      ...
      mr='A-OTF-Ryumin!-Light',
      mb='A-OTF-FutoMinA101!-Bold',
      gr='A-OTF-GothicBBB!-Medium',
      gru='A-OTF-GothicBBB!-Medium',
